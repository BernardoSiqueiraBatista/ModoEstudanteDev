  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 text-sm">
      ...
      <div className="space-y-1 text-slate-600">
        ...
        <p>
          <strong>doctor.id:</strong> {doctor?.id ?? 'null'}
        </p>
        <p>
          <strong>doctor.full_name:</strong> {doctor?.full_name ?? 'null'}
        </p>
        <p>
          <strong>doctor.email:</strong> {doctor?.email ?? 'null'}
        </p>
        <p>
          <strong>doctor.specialty:</strong> {doctor?.specialty ?? 'null'}
        </p>
      </div>
    </div>
  );
