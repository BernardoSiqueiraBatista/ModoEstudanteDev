...
export default function AppointmentCard({
  ...
  return (
    <div className="relative mb-12 group">
      ...
      <div
        className={`glass-effect px-5 py-4 rounded-[2rem] flex items-center justify-between gap-4 max-w-2xl group-hover:scale-[1.01] transition-transform duration-300 ${getBorderStyle()}`}
      >
