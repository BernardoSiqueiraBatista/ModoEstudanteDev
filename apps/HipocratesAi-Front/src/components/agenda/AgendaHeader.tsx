...
import googleCalendarLogo from '../../assets/google_calendar_logo_icon_159345.png';
    ...
    <>
      <header className="flex items-center justify-between px-10 py-6 border-b border-light bg-surface/50 backdrop-blur-md sticky top-0 z-10">
        ...
        <div>
          ...
          <button
            type="button"
            className="mt-2 inline-flex items-center justify-center gap-2 h-9 rounded-lg px-4 py-2 text-sm font-medium bg-white text-slate-900 border border-slate-200 shadow-xs hover:bg-slate-50 disabled:pointer-events-none disabled:opacity-50 transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring whitespace-nowrap"
          >
            <img
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="ml-2 bg-[var(--medical-navy)] text-white px-5 py-2 rounded-xl text-sm font-semibold flex items-center gap-2 shadow-md shadow-[var(--medical-navy)]/20 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-[transform,box-shadow] duration-200 ease-out"
          >
